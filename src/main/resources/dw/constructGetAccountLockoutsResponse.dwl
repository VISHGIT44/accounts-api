...
---
{
	...
	'accountLockouts': messagePayload.fs#Output.fs#Responses.fs#ResponseBase.fs#LockOuts.*ms#LockOut map {
			...
			('lockoutFlagCode': $.LockOutFlagCode) if($.LockOutFlagCode != null),
			('lockoutFlagDescription': $.LockOutFlagDescription) if($.LockOutFlagDescription != null)
	},
