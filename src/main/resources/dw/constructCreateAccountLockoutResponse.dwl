...
---
{
	...
	'accountLockOutResponse': messagePayload.fs#Output.fs#Responses.fs#ResponseBase.fs#LockOutResponses.*cm#LockOutResponse map {
		('accountNumber': $.cm#AccountNumber) if($.cm#AccountNumber != null),
		('effectiveDate': $.cm#EffectiveDate) if($.cm#EffectiveDate  != null),
		('lockoutFlagCode': $.cm#LockOutFlagCode) if($.cm#LockOutFlagCode != null),
